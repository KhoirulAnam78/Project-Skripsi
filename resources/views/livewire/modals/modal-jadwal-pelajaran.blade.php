    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel1">Tambah Jadwal Pelajaran</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-0">
                            ...
                            <select name="mata_pelajaran_id" wire:model="mata_pelajaran_id" id="mata_pelajaran_id"
                                class="form-select">
