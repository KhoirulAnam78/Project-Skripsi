    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel1">Tambah Data Wali Asrama</h5>
                    ...
                    <div class="row g-2">
                        <div class="col mb-0">
                            ...
                            <input type="text" wire:model="username" id="username" class="form-control"
                                placeholder="khoirul1234" value="{{ $username }}" />
...
<div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel1">Edit Data Wali Asrama</h5>
                <button type="button" class="btn-close" wire:click="empty()" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger" wire:click="deleteWaliData()">Delete</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <form wire:submit.prevent="import">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a href="/download-template-wali-asrama" class="btn btn-primary"><i
