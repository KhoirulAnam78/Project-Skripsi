    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel1">Tambah Jadwal Kegiatan</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <select name="kegiatan_id" wire:model="kegiatan_id" id="kegiatan_id" class="form-select">
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col mb-0">
                            ...
                            <select name="angkatan_id" wire:model="angkatan_id" id="angkatan_id" class="form-select">
...
<div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel1">Edit Jadwal Kegiatan</h5>
                <button type="button" class="btn-close" wire:click="empty()" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <form wire:submit.prevent="update">
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            <label for="kegiatan_id" class="form-label">Kegiatan</label>
                            <select name="kegiatan_id" wire:model="kegiatan_id" id="kegiatan_id"
                                class="form-select">
                                <option value="">Pilih Kegiatan</option>
                                @foreach ($kegiatan as $k)
                                    <option value="{{ $k->id }}">{{ $k->nama }}</option>
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col mb-0">
                            <label for="angkatan_id" class="form-label">Angkatan</label>
                            <select name="angkatan_id" wire:model="angkatan_id" id="angkatan_id"
                                class="form-select">
                                <option value="">Pilih Angkatan</option>
                                @foreach ($angkatan as $a)
                                    <option value="{{ $a->id }}">{{ $a->nama }}</option>
                            ...
                            <div class="col-lg-2 col-md-2 mx-3">
                                <div wire:loading.delay
                                    ...
                                    <img src="https://paladins-draft.com/img/circle_loading.gif" width="50"
                                        height="50" class="k-auto mt-1/4"> <span>Loading ...</span>
                                </div>
                            </div>
                            @error('file')
                                <span class="error" style="font-size:12px; font-style:italic">*
